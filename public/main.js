...
// =============================================
// 4. HERO ANIMATIONS (GSAP) — Enhanced Professional with Image Transition
// =============================================
...
function startImageTransition() {
  ...
  function transitionImages() {
    if (currentImage === 1) {
      ...
      // Transition from image 2 to image 1
      gsap.to(img2, {
        opacity: 0,
        scale: 0.95,
        rotationY: 15,
  ...
  // Start transition every 5 seconds
...
// =============================================
// 14. ADVANCED 3D PARALLAX HERO IMAGE — Professional Effect
// =============================================
...
if (heroSection && heroImg1 && heroImg2) {
  // 3D Tilt effect on mouse move for both images
  heroSection.addEventListener("mousemove", (e) => {
    const rect = heroSection.getBoundingClientRect();
    const x = (e.clientX - rect.left) / rect.width - 0.5;
    const y = (e.clientY - rect.top) / rect.height - 0.5;

    // 3D rotation effect for both images
    [heroImg1, heroImg2].forEach(img => {
      gsap.to(img, {
        rotationY: x * 15,
        rotationX: -y * 10,
        x: x * 20,
...
// =============================================
// 15. HERO IMAGE PARTICLES EFFECT
// =============================================
